...
def sudoku_board_to_sat_formula(sudoku_board):
    ...
    # value occurs exactly once in each row and column
    for i in range(n):
...
if __name__ == "__main__":
    ...
    a = sudoku_board_to_sat_formula(board)
    ass = satisfying_assignment(a)
    for key in ass:
        if ass[key]:
            print(key, ass[key])
